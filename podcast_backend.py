...
def get_podcast_summary(podcast_transcript):
  ...
  podcast_summary = ""
  instructPrompt = "create a summary of this podcast: "
...
def get_podcast_guest(podcast_transcript):
  ...
  completion = openai.ChatCompletion.create(
    ...
    functions=[
    {
        ...
        "description": "The function identifies the name of the main guest in a Podcast transcription",
        "parameters": {
            "type": "object",
            "properties": {
                "guest_name": {
                    "type": "string",
                    "description": "Name of the guest talking in the Podcast transcription",
                },
                "unit": {"type": "string"},
            },
            "required": ["guest_name"],
...
def get_podcast_highlights(podcast_transcript):
  ...
  podcastHighlights = ""
  instructPrompt = "ighlight key moments in the podcast transcription. Provide timestamp and description of each moment. Choose 3 moments that are most relevant in the podcast: "
  request = instructPrompt + podcast_transcript
